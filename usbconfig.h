 ...
 * the implications!
 */
#define  USB_CFG_DEVICE_ID       0xdb, 0x27 /* = 0x27db = 10203 */
 ...
 */
#define USB_CFG_VENDOR_NAME     'd', '.', 'i', '1', '0', 'o', '.', 'c', 'a'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'T', 'a', 'b', ' ', 'S', 't', 'o', 'm', 'p', 'e', 'r'
...
#define USB_CFG_INTERFACE_SUBCLASS  0x00   /* No Subclass (not boot) */
